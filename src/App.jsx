...
function App(props) {
  ...
  function handleClick3() {
    axios.get("/api/main42/sub3").then((res) => console.log(res));
  }

  function handleClick4() {
    axios.get("/api/main42/sub4").then((res) => console.log(res));
  }

  function handleClick5() {
    axios.get("/api/main42/sub5").then((res) => console.log(res));
  }

  function handleClick6() {
    axios.get("/api/main42/sub6").then((res) => console.log(res));
  }
