...
function App(props) {
  ...
  function handleClickButton7() {
    const params = new URLSearchParams();
    params.append("id", 3);
    params.append("team", "spurs");
    params.append("position", "mid");
  ...
  function handleClickButton8() {
    ...
    params.append("name", "son");
    params.append("email", "son@son.com");
    params.append("email", "son@pon.com");
  ...
  return (
    <div>
      ...
      <button onClick={handleClickButton7}>get request with data</button>
      <button onClick={handleClickButton8}>post request with data</button>
    </div>
  );
}
